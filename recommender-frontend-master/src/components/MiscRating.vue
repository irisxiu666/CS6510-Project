<template>
  <v-card :color="color" class="mx-auto rating" rounded="lg">
    <v-row>
      <v-col>
        <v-card-title @click="getMovie(movie.mid)">
          <div style="color: #202124">
            ...
            <div
              style="margin-top: 5px; text-align: left; height: 48px; font-size: 1rem; overflow: hidden;line-height: 1.5rem"
            >
              {{ movie.directors }}
            </div>
          </div>
