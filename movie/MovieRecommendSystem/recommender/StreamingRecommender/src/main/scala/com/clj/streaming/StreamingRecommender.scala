...
object ConnHelper extends Serializable{
  lazy val jedis = new Jedis("192.168.118.130")
  lazy val mongoClient = MongoClient( MongoClientURI("mongodb://192.168.118.130:27017/recommender") )
}
...
object StreamingRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 定义kafka连接参数
    val kafkaParam = Map(
      "bootstrap.servers" -> "192.168.118.130:9092",
  ...
  def computeMovieScores(candidateMovies: Array[Int],
    ...
    }.toArray.sortWith(_._2>_._2)//toArray
  }
