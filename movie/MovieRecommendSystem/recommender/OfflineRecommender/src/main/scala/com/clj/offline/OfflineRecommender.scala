...
case class MovieRating(uid: Int, mid: Int, score: Double, timestamp: BigInt )
...
object OfflineRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val (rank, iterations, lambda) = (200, 10, 0.1)//需要调参  ALSTrainer.scala的执行结果为(200,0.1,0.9130422851898058)
